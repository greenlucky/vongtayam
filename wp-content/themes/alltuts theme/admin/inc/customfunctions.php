...
function custom_login_logo() {
    ...
    $logo_attrs = getimagesize(of_get_option('snb_clogo'));
    echo '<style type="text/css">
    #login h1 a {height:'.@$logo_attrs[1].'px !important;  background-image: url('.of_get_option('snb_clogo').') !important; background-size: auto !important;  }
    </style>';
    }
}
