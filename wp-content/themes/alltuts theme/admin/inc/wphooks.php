...
function site5framework_custom_shortcut_favicon() {
	if (of_get_option('alltuts_custom_shortcut_favicon') != '') {
    echo '<link rel="shortcut icon" href="'. of_get_option('alltuts_custom_shortcut_favicon') .'" type="image/ico" />'."\n";
	}
...
function site5framework_custom_icon() {
	if (of_get_option('alltuts_custom_shortcut_favicon') != '') {
    echo '<link rel="icon" href="'. of_get_option('alltuts_custom_shortcut_favicon') .'" type="image/ico" />'."\n";
	}
...
function site5framework_custom_apple_touch_icon() {
	if (of_get_option('alltuts_custom_apple_touch_icon') != '') {
    echo '<link rel="apple-touch-icon" href="'. of_get_option('alltuts_custom_apple_touch_icon') .'" type="image/png" />'."\n";
	}
...
function site5framework_custom_apple_touch_icon_precomposed() {
	if (of_get_option('alltuts_custom_apple_touch_icon') != '') {
    echo '<link rel="apple-touch-icon-precomposed" href="'. of_get_option('alltuts_custom_apple_touch_icon') .'" type="image/png" />'."\n";
	}
...
function site5framework_custom_icon_image() {
	if (of_get_option('alltuts_custom_icon_image') != '') {
    echo '<link rel="icon" href="'. of_get_option('alltuts_custom_icon_image') .'" type="image/png" />'."\n";
	}
...
function site5framework_contactform_init() {
    ...
    wp_enqueue_script('contactform', get_template_directory_uri().'/js/contactform/contactform.js');
    }
}
...
function site5framework_analytics(){
	$output = of_get_option('alltuts_stats');
	if ( $output <> "" )
...
function nivo_home_js() {
    if (is_home() && of_get_option('alltuts_slidertype') == 'nivo' && !is_admin()) {
        wp_enqueue_script('nivo-slider', get_template_directory_uri().'/js/jquery.nivo.slider.pack.js', array('jquery'), '1.0');
