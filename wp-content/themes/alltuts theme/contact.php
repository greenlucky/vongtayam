...
if(isset($_POST['submitted'])) {
		...
		if(!isset($hasError)) {
			...
			$emailTo = ''.get_option('alltuts_contact_email').'';
...
<!-- begin section -->
    ...
    <!-- Begin .postBox -->
		...
		<article>
            ...
            <p><?php echo stripslashes(stripslashes(of_get_option('alltuts_contact_text')))?></p>
            </header>
            <?php
                if(of_get_option('alltuts_contact_map')!="") {
            ?>
                <div id="contact-map">
                    <?php echo of_get_option('alltuts_contact_map'); ?>
                </div>
            <?php } ?>
            ...
            <div id="contact-data">
                    <?php
                        if(of_get_option('alltuts_contact_address')!="") {
                    ?>	<p>
                        <span class="contact-data-field"><?php _e("Address", "site5framework"); ?>:</span>
                        <span class="contact-data-info"><?php echo of_get_option('alltuts_contact_address'); ?></span>
                        </p>
                    <?php } ?>
                    <?php
                        if(of_get_option('alltuts_contact_phone')!="") {
                    ?>	<p>
                        <span class="contact-data-field"><?php _e("Phone", "site5framework"); ?>:</span>
                        <span class="contact-data-info"><?php echo of_get_option('alltuts_contact_phone'); ?></span>
                        </p>
                    <?php } ?>
                    <?php
                        if(of_get_option('alltuts_contact_fax')!="") {
                    ?>	<p>
                        <span class="contact-data-field"><?php _e("Fax", "site5framework"); ?>:</span>
                        <span class="contact-data-info"><?php echo of_get_option('alltuts_contact_fax'); ?></span>
                        </p>
                    <?php } ?>
            </div>
